...
# password. However, the program throws an error. What is the problem
...
# Solution
# It was necessary to pass the password into #verify_password
# And assign the password to a variable when setting it
