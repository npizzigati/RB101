...
# input: year integer
# output: true or false, depending on whether year is leap year

# algorithm: if year % 4 == 0 then leap unless year % 100 == 0 && year % 400 != 0

def leap_year?(year)
  leap = false
  if year % 4 == 0
    leap = true unless year % 100 == 0 && year % 400 != 0
  end
  leap
end
